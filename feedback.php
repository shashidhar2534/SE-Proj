...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <form method="post" action=""
        ...
        <div class="form-group">
            <h5 class="xyz">Enter your feedback</h5>
...
<?php
    ...
    if(isset($_POST['x'])){
		...
		$insert_user = "INSERT INTO FeedBack (Name,EmailAddress,Subject,Rating,FeedBack) VALUES ('$name','$email','$subject','$rating','$feedback')";
