...
//Connect database
	...
	//input
		...
		//payment
		else if(isset($_POST['viewpay'])) {
			header('Refresh: 0; pay_view.php');
		}
?>
...
<body background="image\lo.jpg">
	<hr width="auto" size="10" style="background: #C24641"><br>
	<form action="" method="POST">
		...
		<table align="center" cellspacing="20px">
			<tr>
				<td width="300px">Payment Status:</td>
				
				<td><input type="submit" name="viewpay" value="View"></td>
			</tr>
		</table>

	</form>
		<br><hr width="auto" size="10" style="background: #C24641">
</body>
</html>